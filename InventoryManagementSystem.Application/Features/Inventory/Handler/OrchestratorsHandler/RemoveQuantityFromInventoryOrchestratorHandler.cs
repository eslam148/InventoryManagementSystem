...
{
    public class RemoveQuantityFromInventoryOrchestratorHandler : IRequestHandler<RemoveQuantityFromInventoryOrchestrator, BaseReponseGeneric<bool>>
    {
        private readonly IMediator _mediator;
        public RemoveQuantityFromInventoryOrchestratorHandler(IMediator mediator)
        {
            _mediator = mediator;
        }
        public async Task<BaseReponseGeneric<bool>> Handle(RemoveQuantityFromInventoryOrchestrator request, CancellationToken cancellationToken)
        {
